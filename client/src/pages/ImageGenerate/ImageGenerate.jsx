...
const ImageGenerate = () => {
    ...
    const [selectedColorOption, setSelectedColorOption] = useState('none');
    ...
    const dataURLtoFile = (dataUrl, filename) => {
        ...
        // A utility to detect if the image is SVG
        const isSVG = (image) => {
            return image && image.startsWith("data:image/svg+xml");
        };
    // Function to reset the form and clear the state
    // const handleReset = () => {
    //     // Reset to the original image by clearing the processed image state
    //     setProcessedImage(null);
    // };
    return (
        <div className="image-generator-container">
            <h1><span className="dalle">ASG Art Therapy: </span> Color, Create, Heal</h1>
            ...
            <div className="content">
                ...
                <div className="image-container">
                    {uploadedImage ? (
                        ...
                        />
                    //     <img
                    //     src={isSVG(uploadedImage) ? uploadedImage : (generatedImage || assets.image_placeholder)}
                ...
                <div className="button-container">
                    ...
                    {generatedImage && (
                            <a
                                href={generatedImage}
                                // download={`generated-image.${selectedColorOption === 'vector' ? 'svg' : 'png'}`}
            ...
            {/* <section className="bg-stars">
                ...
                <p>Avoid using shorthand, abbreviations, or unclear text in your requests. The system may misinterpret or reject prompts that are too short, vague, or contain abbreviations that lack context.</p>
        </div>
